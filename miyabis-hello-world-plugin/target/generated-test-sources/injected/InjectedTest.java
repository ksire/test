...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:miyabis-hello-world-plugin:1.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","C:\\Users\\note\\Source\\JenkinsPlugins\\miyabis-hello-world-plugin");
    parameters.put("artifactId","miyabis-hello-world-plugin");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","C:\\Users\\note\\Source\\JenkinsPlugins\\miyabis-hello-world-plugin\\target\\classes");
    parameters.put("testOutputDirectory","C:\\Users\\note\\Source\\JenkinsPlugins\\miyabis-hello-world-plugin\\target\\test-classes");
